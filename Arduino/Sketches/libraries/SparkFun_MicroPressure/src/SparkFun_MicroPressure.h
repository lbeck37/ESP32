// SparkFun_MicroPressure.h, Beck, 3/16/22b
#pragma once
...
{
  public:
    SparkFun_MicroPressure      (int8_t eoc_pin= -1, int8_t rst_pin= -1,
                                 uint8_t minimumPSI= MINIMUM_PSI, uint8_t maximumPSI= MAXIMUM_PSI);
